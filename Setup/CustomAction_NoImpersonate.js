...
if (WScript.Arguments.Length != 1 || WScript.Arguments(0).Length == 0)
{
	WScript.StdErr.WriteLine("Invalid arguments supplied. You must pass the file path of the MSI to modify.");
	WScript.Quit(1);
}

var filespec = WScript.Arguments(0);

WScript.StdOut.WriteLine("Setting 'NoImpersonate' flag for: " + filespec);
